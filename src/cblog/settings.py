...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cbnxm4vq29ou.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-hasna-blog' # please enter your s3 bucket name
